...
class User extends \TYPO3\CMS\Extbase\DomainObject\AbstractEntity
{
    ...
    /**
     * txRbgeo2addressLatitude
     *
     * @var string
     * @validate NotEmpty
     */
    protected $txRbgeo2addressLatitude = '';

    /**
     * txRbgeo2addressLongitude
     *
     * @var string
     * @validate NotEmpty
     */
    protected $txRbgeo2addressLongitude = '';

    /**
     * txRbgeo2addressTimezone
     *
     * @var string
     * @validate NotEmpty
     */
    protected $txRbgeo2addressTimezone = '';
    ...
    /**
     * Returns the txRbgeo2addressLatitude
     *
     * @return string $txRbgeo2addressLatitude
     */
    public function getTxRbgeo2addressLatitude()
    {
        return $this->txRbgeo2addressLatitude;
    }
    
    /**
     * Sets the txRbgeo2addressLatitude
     *
     * @param string $txRbgeo2addressLatitude
     * @return void
     */
    public function setTxRbgeo2addressLatitude($txRbgeo2addressLatitude)
    {
        $this->txRbgeo2addressLatitude = $txRbgeo2addressLatitude;
    }

    /**
     * Returns the txRbgeo2addressLongitude
     *
     * @return string $txRbgeo2addressLongitude
     */
    public function getTxRbgeo2addressLongitude()
    {
        return $this->txRbgeo2addressLongitude;
    }
    
    /**
     * Sets the txRbgeo2addressLongitude
     *
     * @param string $txRbgeo2addressLongitude
     * @return void
     */
    public function setTxRbgeo2addressLongitude($txRbgeo2addressLongitude)
    {
        $this->txRbgeo2addressLongitude = $txRbgeo2addressLongitude;
    }
    
    /**
     * Returns the txRbgeo2addressTimezone
     *
     * @return string $txRbgeo2addressTimezone
     */
    public function getTxRbgeo2addressTimezone()
    {
        return $this->txRbgeo2addressTimezone;
    }
     ...
     * @return void
     */
    public function setTxRbgeo2addressTimezone($txRbgeo2addressTimezone)
    {
        $this->txRbgeo2addressTimezone = $txRbgeo2addressTimezone;
    }



    /**
     * Returns the timezoneDate
     *
     * @return string $timezoneDate
     */
    ...
    /**
     * Sets the timezoneDate
     *
     * @param string $timezoneDate
     * @return void
     */
    public function setTimezoneDate($timezoneDate)
    {
